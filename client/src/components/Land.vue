    ...
    <div class="container">
      <div class="row about">
        <div class="col-md-4 col-sm-12 about-section">
          ...
          <h3><b>100% anonymous.</b></h3>
          <p><i>Get and give candid "off the record" feedback.</i></p>
        </div>
        <div class="col-md-4 col-sm-12 about-section">
          <h3><b>Private</b></h3>
          <icon class="about-icon" name="lock" scale="5"></icon>
          <h3><b>Insiders only.</b></h3>
          <p><i>Members start threads about things you care about.</i></p>
        </div>
        <div class="col-md-4 col-sm-12 about-section">
          <h3><b>Exclusive</b></h3>
          <icon class="about-icon" name="stop-circle" scale="5"></icon>
          <h4><b>No boys allowed.</b></h4>
          <p><i>And no party crashers.</i></p>
        </div>
      </div>
    </div>
  </div>
